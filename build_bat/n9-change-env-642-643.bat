...
copy D:\n9_servers\sms_web\apache-tomcat-6.0.32\conf\server-642.xml D:\n9_servers\sms_web\apache-tomcat-6.0.32\conf\server.xml

del D:\n9_servers\fss_web\apache-tomcat-6.0.32\conf\server.xml
copy D:\n9_servers\fss_web\apache-tomcat-6.0.32\conf\server-643.xml D:\n9_servers\fss_web\apache-tomcat-6.0.32\conf\server.xml

del D:\n9_servers\fss_sms_services\apache-tomcat-6.0.32\conf\server.xml
copy D:\n9_servers\fss_sms_services\apache-tomcat-6.0.32\conf\server-642-643.xml D:\n9_servers\fss_sms_services\apache-tomcat-6.0.32\conf\server.xml
